...
const Hero = () => {
  return (
    <div className="relative border-b border-neutral-900 pb-10 lg:mb-35 overflow-hidden">
      ...
      {/* Background Glow */}
      <div className="absolute top-[-100px] left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-purple-600 opacity-20 blur-[120px] rounded-full"></div>
        ...
        <div className="w-full lg:w-1/2 lg:p-5">
          <div className="flex justify-center">
            ...
            >
              ...
              {/* Image Glow */}
              <div className="absolute inset-0 bg-purple-500 opacity-30 blur-2xl rounded-2xl"></div>
